#
#  Be sure to run `pod spec lint MQTTKit_KUN.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "文堃 杜" => "ken.bug@qq.com" }
  # Or just: s.author    = "文堃 杜"
  # s.authors            = { "文堃 杜" => "ken.bug@qq.com" }
  # s.social_media_url   = "http://twitter.com/文堃 杜"
